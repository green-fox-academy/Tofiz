...
if (f1 > f2) {
    ...
    console.log("No, it is not bigger.")
...
console.log( h % 11 === 0 ); // egesz-e, egész-e, osztas utani maradek, osztás utáni maradék
...
console.log (Math.pow(i2, 2) < i1 < Math.pow(i2, 3)); //hatványozás hatvanyozas
